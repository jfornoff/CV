...
\cventry{2011--2016}{TU Darmstadt}{BSc Wirtschaftsinformatik}{}{Average grade \textit{2,27}}{Bachelor Thesis: \emph{Optimization and Evaluation of MPEG DASH Video Streaming by large-scale Network Simulation} (Grade 1,0)}{}{}
\cventry{2016--now}{TU Darmstadt}{MSc Wirtschaftsinformatik}{}{}{}{}{}
...
\cventry{Nov. 2010--Apr. 2011}{Civilian service}{DRK Menüservice}{}{}{}%
...
\end{itemize}}
\cventry{Sep. 2017--now}{Working student (Remote)}{Grandcentrix GmbH}{Cologne}{}{Backend development (Elixir) \newline{}
  \begin{itemize}
    \item Application development using CQRS / Event Sourcing paradigms
...
\smallskip
\cventry{}{}{Project during course "'IT project management"'}{Invensity GmbH (Wiesbaden)}{}{Development von HTML5-Application for collection of customer feedback (AngularJS 1.x - Frontend, Laravel - Backend)}

\medskip

\cventry{}{}{Project during course "'Creating Value through Data Science"'}{Accenture Digital}{}{Analytics challenge with the goal of getting insights into the profession of Data Scientists. \newline{}
\begin{itemize}
  \item Business case definition
  \item Preparing data for analysis
  \item Statistical data analysis and modelling
  \item Prototype development including visualization
...
{Technologies}
{
  \begin{itemize}
    ...
    \item Network protocols (HTTP, TCP, Multipath TCP)
  \end{itemize}
}
